...
<body>
    ...
    <div class="page-wrapper">
                ...
                <div class="container">
                    ...
                    <div class="main-nav__logo-box">
                        <a href="index.html" class="main-nav__logo">
                            <img src="assets/images/fappree_logo.png" width="105" alt="Awesome Image" />
                        </a>
                    ...
                    <div class="main-nav__main-navigation">
                        <ul class="one-page-scroll-menu main-nav__navigation-box">
                            ...
                            <li class="dropdown scrollToLink" style='display:none;'>
                                <a href="#blog">Blog</a>
                                <ul>
                    ...
                    <div class="main-nav__right" style='display:none;'>
                        <a href="#contact" data-target="#contact" class="thm-btn header__btn scroll-to-target"><i class="fa fa-download" aria-hidden="true"></i> Download</a><!-- /.thm-btn header__btn -->
                    </div><!-- /.main-nav__right -->
                </div>
                <!-- /.container -->
            </nav>
                ...
                <div class="row">
                    <div class="col-lg-7">
                        <div class="banner-one__content">
                            <p class="banner-one__tag-line">Welcome to FAPPREE  <a href="#">Friend Appreciation App</a></p>
                            <h3>Share love <br> and Apppreciation</h3>
                            <p> <br> Connecting with friends and loved ones and sending them inspiring thoughts and messages has never been easier.</p>
                            <a href="#contact" data-target="#contact" class="thm-btn banner-one__btn scroll-to-target"><i class="fa fa-android" aria-hidden="true"></i> Android</a><!-- /.thm-btn banner-one__btn -->
                            <a href="#contact" data-target="#contact" class="thm-btn banner-one__btn scroll-to-target"><i class="fa fa-apple" aria-hidden="true"></i> iOS</a>
        ...
        <section class="service-one" id="features">
            <div class="container">
                <div class="block-title text-center">
                    ...
                    <p>Check out FAPPREE Features</p>
                    <h3>Show appreciation to those you care about</h3>
                </div><!-- /.block-title -->
                <div class="row">
        ...
        <div class="cta-three">
            ...
            <img src="assets/images/shapes/cta-1-shape-3.png" alt="" class="cta-three__shape-3">
            <div class="container">
                <img src="assets/images/shapes/cta-1-shape-1.png" alt="" class="cta-three__shape-1">
                <img src="assets/images/mocs/cta-moc-1-1.png" alt="" class="cta-three__moc">
                <div class="row justify-content-end">
                    <div class="col-lg-6">
                        <div class="cta-three__content">
                            <div class="block-title text-left">
                                <span class="block-title__bubbles"></span>
                                <p>FAPPREE Features</p>
                                <h3>Setup and Use is FREE</h3>
                            </div><!-- /.block-title -->
                            <div class="cta-three__box-wrap">
                                <div class="cta-three__box">
                                    ...
                                    <div class="cta-three__box-content">
                                        <h3>Free Setup</h3>
                                        <p>There is no monetary fees or charges to downloading, installing and using the app. It is simple and easy to setup on your device. Try it now.</p>
                                ...
                                <div class="cta-three__box">
                                    ...
                                    <div class="cta-three__box-content">
                                        <h3>Quick Access</h3>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor anagi
        ...
        <section class="cta-two">
            ...
            <div class="container">
                <img src="assets/images/shapes/cta-2-shape-3.png" alt="" class="cta-two__shape-3">
                <img src="assets/images/mocs/cta-moc-2-1.png" alt="" class="cta-two__moc mt-5">
                <div class="row">
                    <div class="col-xl-5 col-lg-6">
                        <div class="cta-two__content">
                            <div class="block-title text-left">
                                <span class="block-title__bubbles"></span>
                                <p>FAPPREE Features</p>
                                <h3>Quick and Simple to Connect</h3>
                            </div><!-- /.block-title -->
                            <div class="cta-three__box-wrap">
                                <div class="cta-three__box">
                                    <div class="cta-three__box-icon">
                            ...
                            <a href="#" class="thm-btn cta-two__btn mt-3">Discover More</a><!-- /.thm-btn cta-two__btn -->
            ...
            <div class="container">
                <div class="video-one__box wow fadeInUp" data-wow-duration="1500ms">
                    ...
                    <div class="video-one__content">
                        <a href="https://www.youtube.com/watch?v=U3ASj1L6_sY" class="video-popup"><i class="fa fa-play"></i></a>
        ...
        <section class="funfact-one" style='display:none;'>
            <img src="assets/images/shapes/pricing-shape-1.png" alt="" class="funfact-one__shape-1">
            <img src="assets/images/shapes/pricing-shape-2.png" alt="" class="funfact-one__shape-2">
            <img src="assets/images/shapes/pricing-shape-3.png" alt="" class="funfact-one__shape-3">
        ...
        <section class="app-shot-one" id="app-shots">
            <img src="assets/images/shapes/contact-shape-3.png" alt="" class="app-shot__shape-1">
            <img src="assets/images/shapes/contact-shape-2.png" alt="" class="app-shot__shape-2">
        ...
        <section class="testimonials__one" id="testimonials">
            <img src="assets/images/shapes/map-1-1.png" alt="Awesome Image" class="map-img" />
            <img src="assets/images/shapes/testi-shape-1.png" alt="" class="testimonials__one-shape-1">
            <img src="assets/images/shapes/testi-shape-2.png" alt="" class="testimonials__one-shape-2">
            <div class="container">
                <div class="row">
                        ...
                        <div class="my-auto wow fadeInUp" data-wow-duration="1500ms">
                            <div id="testimonials-slider-pager">
                                <div class="testimonials-slider-pager-one">
                                    <a href="#" class="pager-item active" data-slide-index="0"><img src="assets/images/testimonials/testi-1-1.jpg" alt="Awesome Image" /></a>
                                    <a href="#" class="pager-item" data-slide-index="1"><img src="assets/images/testimonials/testi-1-2.jpg" alt="Awesome Image" /></a>
                                    <a href="#" class="pager-item" data-slide-index="2"><img src="assets/images/testimonials/testi-1-3.jpg" alt="Awesome Image" /></a>
                                    <a href="#" class="pager-item" data-slide-index="3"><img src="assets/images/testimonials/testi-1-4.jpg" alt="Awesome Image" /></a>
                                    <a href="#" class="pager-item" data-slide-index="4"><img src="assets/images/testimonials/testi-1-5.jpg" alt="Awesome Image" /></a>
                                    <a href="#" class="pager-item" data-slide-index="5"><img src="assets/images/testimonials/testi-1-6.jpg" alt="Awesome Image" /></a>
        ...
        <section class="brand-one brand-one__home-one">
            <div class="container text-center" style='color:white;'>
                <h1>Join the FAPPREE Community</h1>
                <div style='display:none;' class="brand-one__carousel owl-carousel thm__owl-carousel owl-theme" data-options='{"loop": true, "autoplay": true, "autoplayHoverPause": true, "autoplayTimeout": 5000, "items": 5, "dots": false, "nav": false, "margin": 100, "smartSpeed": 700, "responsive": { "0": {"items": 2, "margin": 30}, "480": {"items": 3, "margin": 30}, "991": {"items": 4, "margin": 50}, "1199": {"items": 5, "margin": 100}}}'>
                    <div class="item">
        ...
        <section class="faq-one" style='display:none;'>
            <img src="assets/images/shapes/faq-shape-1.png" alt="" class="faq-one__shape-1">
            <img src="assets/images/shapes/faq-shape-2.png" alt="" class="faq-one__shape-2">
            <img src="assets/images/shapes/faq-shape-3.png" alt="" class="faq-one__shape-3">
            <div class="container">
                <div class="block-title text-center">
                    <span class="block-title__bubbles"></span>
                            ...
                            <div class="accrodion-content">
                                <div class="inner">
                                    <p>There are many variations of passages of available but majority have alteration in some
                                        by inject humour or random words. Lorem ipsum dolor sit amet, error insolens reprimique
        ...
        <section class="blog-one blog-one__home" id="blog" style='display:none;'>
                    ...
                    <div class="col-lg-4 wow fadeInLeft" data-wow-duration="1500ms">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3><a href="blog-details.html">Pre and post launch mobile app marketing pitfalls to avoid</a>
                                </h3>
                    ...
                    <div class="col-lg-4 wow fadeInUp" data-wow-duration="1500ms">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3><a href="blog-details.html">It is all exactly as i said, but i don't like it let's unpack
                                        that</a></h3>
                                <a href="blog-details.html" class="blog-one__link"><i class="zimed-icon-right-arrow"></i></a>
                                <!-- /.blog-one__link -->
                            </div><!-- /.blog-one__content -->
                    ...
                    <div class="col-lg-4 wow fadeInRight" data-wow-duration="1500ms">
                        <div class="blog-one__single">
                            ...
                            <div class="blog-one__content">
                                ...
                                <h3><a href="blog-details.html">I just wanted to give you a heads-up, or this you feel you
                                        would</a></h3>
                                <a href="blog-details.html" class="blog-one__link"><i class="zimed-icon-right-arrow"></i></a>
                                <!-- /.blog-one__link -->
                            </div><!-- /.blog-one__content -->
                        ...
                        <div class="contact-one__content">
                            ...
                            <div class="contact-one__infos">
                                ...
                                <div class="contact-one__infos-single">
                                    ...
                                    <div class="contact-one__infos-content">
                                        <h3>Email</h3>
                                        <p><a href="mailto:info@fappree.com">info@fappree.com</a></p>
                                    </div><!-- /.contact-one__infos-content -->
                                </div><!-- /.contact-one__infos-single -->
                                <div class="contact-one__infos-single">
                                    <div class="contact-one__infos-icon">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="discuss" class="selectpicker">
                                            ...
                                            <option value="">Business Inquery</option>
                                            <option value="">App Review</option>
                                        </select>
                                    </div><!-- /.col-md-6 -->
                                    <div class="col-md-12">
        ...
        <section class="cta-one">
            <div class="container">
                ...
                <div class="cta-one__content text-center">
                    ...
                    <p>and get started in bettering your relationships</p>
                    <a href="#" class="thm-btn cta-one__btn">Download Our App</a><!-- /.thm-btn cta-one__btn -->
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="footer-widget footer-widget__about">
                                <a class="footer-widget__logo" href="index.html"><img src="assets/images/fappree_logo.png" width="105" alt="Awesome Image" /></a>
                                <p>FAPPREE is a Friends Appreciation App which make connecting with friends and loved ones quick and easy and gives you a medium to creatively in a fun way show them that you care about them. </p>
                                <p><a href="mailto:info@fappree.com">info@fappree.com</a> <br /> <a href="tel:"></a></p>
                            </div><!-- /.footer-widget -->
                        </div><!-- /.col-lg-4 -->
                        <div class="col-lg-4">
            ...
            <div class="site-footer__bottom">
                <div class="container">
                    <div class="inner-container">
                        ...
                        <p>© copyright 2021. fappree.com. </p>
                    </div><!-- /.inner-container -->
                </div><!-- /.container -->
